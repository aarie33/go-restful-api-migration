...
func setupTestDB() *sql.DB {
	db, err := sql.Open("mysql", "root@tcp(localhost:3306)/go-rest-test2")
...
func TestCreateCategorySuccess(t *testing.T) {
	...
	assert.Equal(t, http.StatusOK, respose.StatusCode)
...
func TestCreateCategoryFailed(t *testing.T) {
	...
	respose := recorder.Result()
	assert.Equal(t, http.StatusBadRequest, respose.StatusCode)
...
func TestGetCategoryFailed(t *testing.T) {
	...
	respose := recorder.Result()
	assert.Equal(t, http.StatusNotFound, respose.StatusCode)
...
func TestUnauthorized(t *testing.T) {
	...
	respose := recorder.Result()
	assert.Equal(t, http.StatusUnauthorized, respose.StatusCode)
